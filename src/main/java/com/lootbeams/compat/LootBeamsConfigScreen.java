    ...
    public static Screen getConfigScreen(Screen parent){
        ...
        main.addEntry(builder.entryBuilder().startBooleanToggle(Text.of("Render Name Color"), LootBeams.config.renderNameColor)
                ...
                .addEntry(builder.entryBuilder().startFloatField(Text.of("Render Distance"), LootBeams.config.renderDistance)
                        ...
                        .build())
                .addEntry(builder.entryBuilder().startFloatField(Text.of("Fade Distance"), LootBeams.config.fadeDistance)
                        .setDefaultValue(2)
                        .setMin(0)
                        .setMax(24)
                        .setSaveConsumer(value -> LootBeams.config.fadeDistance = value)
                        .setTooltip(Text.of("How close the player has to be to no longer see the beam.\n (note: smooth fade distance is 1 unit)"))
                        .build())
